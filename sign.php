            ...
            <div class="input-box">
              <header class="h1 text-success">Create Account</header>
                ...
                <div class="input-field form-floating mb-3">
                  <input type="text" class="input input form-control form-control-lg bg-light" id="floatingInput" required placeholder="password">
                  <label for="password floatingInput"><i class="bi bi-lock-fill"></i>          Password</label>
                </div>
                <small>Already have an account?<a href="Login.php">Login</a></small>
                
                <div class="input-field">
                  <input type="submit" class="submit btn btn-lg btn-primary w-100 fs-6" value="Sign Up">
                </div>
                </div>
            </div>
          </div>
